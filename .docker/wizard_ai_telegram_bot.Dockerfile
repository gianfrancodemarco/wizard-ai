...
COPY wizard_ai_telegram_bot/pyproject.toml wizard_ai_telegram_bot/poetry.lock ./
...
ENTRYPOINT ["python", "-u", "-m", "debugpy", "--listen", "0.0.0.0:5678", "wizard_ai_telegram_bot/main.py"]
